...
function enableButtons () {
    ...
    btn = document.getElementById("sum_button");
    btn.onclick=function(){sumNumbers();};

    // Update the button label now that the button is active
    btn.value="Click me for a sum numbers";
...
function sumNumbers(){
    ...
    var request = gapi.client.helloworldendpoints.sumNumbers({'a': a, 'b':b});
    request.execute(sayHelloCallback);
}